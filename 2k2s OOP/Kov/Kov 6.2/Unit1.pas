...
begin
  ...
  PointX1 := Trunc(Trunc(RadCircle / 4) * cos(60 * (Angle)) + CenterX);
  PointY1 := Trunc(Trunc(RadCircle / 4) * sin(60* (Angle)) + CenterY);
  ...
  Image1.Canvas.LineTo(CenterX-(PointX1-CenterX),CenterY-(PointY1-CenterY));
