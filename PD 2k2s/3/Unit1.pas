...
begin
  ...
  memo1.lines.Add('Связь1: a_02-a_12:');
  ...
  memo1.lines.Add('Связь2: a_02-a_11:');
  memo1.lines.Add('P: ' + floattostr(p));
  memo1.lines.Add('C: ' + floattostr(c));
  memo1.lines.Add('M: ' + floattostr(m));
  ...
  memo1.lines.Add('Связь1: a_02-a_12-a_21:');
  memo1.lines.Add('P: ' + floattostr(p));
  memo1.lines.Add('C: ' + floattostr(c));
  memo1.lines.Add('M: ' + floattostr(m));
  ...
  memo1.lines.Add('Связь2: a_02-a_12-a_22:');
  memo1.lines.Add('P: ' + floattostr(p));
  memo1.lines.Add('C: ' + floattostr(c));
  memo1.lines.Add('M: ' + floattostr(m));
  ...
  memo1.lines.Add('Связь3: a-02-a_11-a-22:');
  memo1.lines.Add('P: ' + floattostr(p));
  memo1.lines.Add('C: ' + floattostr(c));
  memo1.lines.Add('M: ' + floattostr(m));

  Check(c, m, 2);
  memo1.lines.Add('-----------Вывод: -----------');

  for i := 0 to 2 do
    if mArr[i] = True then
      memo1.Lines.Add('Связка' + inttostr(i+1) + ': Подходит!')
    else
      memo1.Lines.Add('Связка' + inttostr(i+1) + ': Не подходит!')
end;
...
begin
  ...
  stringgrid1.Cells[0,1] := 'А0_ЭД';
  stringgrid1.Cells[0,4] := 'А1_ПМ';
  stringgrid1.Cells[0,7] := 'А2_ИМ';

  stringgrid1.Cells[1,1] := 'А01';
  stringgrid1.Cells[1,2] := 'А02';

  stringgrid1.Cells[1,4] := 'А_11';
  stringgrid1.Cells[1,5] := 'А_12';

  stringgrid1.Cells[1,7] := 'А_21';
  stringgrid1.Cells[1,8] := 'А_22';
